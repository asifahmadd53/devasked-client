...
import { ProblemCard, problems } from '@/components/ProblemCard';
                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                ...
                                <div className="mt-2 flex flex-col lg:flex-row items-center justify-center gap-3">
                                    <Button
                                        asChild
                                        size="lg"
                                        className="px-5 text-base w-44 max-w-44">
                                        <Link href="/sign-up">
                                    ...
                                    <Button
                                        ...
                                        className="px-5 text-base w-44 max-w-44">
                                        <Link href="/questions">
                                            <span className="text-nowrap">Browse Questions</span>
                                        </Link>
                                    </Button>
                                </div>
                ...
                <section className="pb-16 md:pb-32">
                    <div className="group relative m-auto max-w-5xl px-6">
                        <div className="absolute inset-0 z-10 flex scale-95 items-center justify-center opacity-0 duration-500 group-hover:scale-100 group-hover:opacity-100">
                            <Link
                                href="/"
                                className="text-sm text-red-800 duration-150 hover:opacity-75">
