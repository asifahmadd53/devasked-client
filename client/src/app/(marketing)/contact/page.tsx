...
export default function ContactFormSection() {
    ...
    return (
        <section className="relative overflow-hidden px-6 py-24 sm:px-8 md:py-28">
            ...
            <div className="mx-auto flex max-w-6xl flex-col items-center gap-12 text-center">
                ...
                <Card className="group relative w-full max-w-6xl overflow-hidden rounded-2xl border border-border/40 bg-background/60 p-0 backdrop-blur">
